...
from cmdb.utils.pager import PageInfo
from cmdb.utils.response import BaseResponse
    ...
    def __init__(self):
        ...
        table_config = [
            ...
            },
            {
                ...
                'display': 1,
                'text': {
                    'content': "<a href='/cmdb/asset-{device_type_id}-{nid}/'>查看详细</a> | <a href='/cmdb/edit-asset-{device_type_id}-{nid}/'>编辑</a>",
        ...
        extra_select = {
            ...
            'network_title': 'select management_ip from cmdb_networkdevice where cmdb_networkdevice.asset_id=cmdb_asset.id and cmdb_asset.device_type_id=2',
        }

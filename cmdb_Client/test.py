...
response = requests.post(
    url='http://127.0.0.1:8000/api/asset1/',
    json=host_data,
...
# requests.get(url='http://127.0.0.1:8000/api/asset/?k1=123',headers={'authkey': authkey_time})
# requests.get(url='http://127.0.0.1:8000/api/asset/',params={'k1':'v1,v3','k2':'v2'})
# requests.post(
#     url='http://127.0.0.1:8000/api/asset1/',

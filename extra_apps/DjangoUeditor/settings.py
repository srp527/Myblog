...
UEditorUploadSettings = {
    ...
    "scrawlUrlPrefix": "",
    "scrawlPathFormat": "article/ueditor/",

    # 截图工具上传 */
    "snapscreenActionName": "uploadimage",  # 执行上传截图的action名称 */
    "snapscreenPathFormat": "article/ueditor/",
    "snapscreenUrlPrefix": "",

    # 抓取远程图片配置 */
    "catcherLocalDomain": ["127.0.0.1", "localhost", "img.baidu.com"],
    "catcherPathFormat": "article/ueditor/",
    ...
    "videoPathFormat": "article/ueditor/",
    ...
    "filePathFormat": "article/ueditor/{yyyy}-{mm}-{dd}-{HH}-{MM}-{SS}.%(extname)s",
    ...
    "imageManagerListPath": "article/ueditor/",
    ...
    "fileManagerListPath": "article/ueditor/",
